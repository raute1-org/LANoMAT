...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Raised from Livewire's 12 MB default to 1 GB: voice-client
        // installers (Mumble/TeamSpeak client bundles) and the M7 file-sharing
        // feature legitimately exceed 12 MB. Must stay <= the PHP
        // upload_max_filesize/post_max_size (docker/frankenphp/php.ini in prod,
        // host php.ini in dev) and is mirrored by each FileUpload's ->maxSize().
        'rules' => ['required', 'file', 'max:'.env('LIVEWIRE_MAX_UPLOAD_KB', 1048576)], // 1 GB (KB)
